/*============================================================================
 ...
 R2  v14.8.1 remove false-disabled compile-time stub; always build USB host path

 NOTES
 - This version removes the CONFIG_USB_HOST_ENABLED stub branch that was
   incorrectly forcing the module inactive on the user's ESP-IDF 5.3.1 setup.
 - If USB host support is truly unavailable in the build, this file will fail
   at compile time rather than silently falling back to the inactive stub.
