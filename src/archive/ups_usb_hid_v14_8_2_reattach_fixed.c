/*============================================================================
 ...
 R3  v14.8.2 reattach recovery cleanup path (this file)

 NOTES
 - This version always builds the real USB host path.
 - If USB host support is unavailable in the build, it should fail at compile time
   rather than silently falling back to an inactive stub.
 - Reattach recovery now explicitly resets session state after DEV_GONE.
