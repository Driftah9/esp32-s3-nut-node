/*============================================================================
 ...
 RESPONSIBILITY
 - Plaintext NUT upsd-like server on tcp/3493
 - Reads current values from ups_state snapshot
 - Exposes expanded UPS variables when valid

 REVERT HISTORY
 R0  v14.7 LAN interop baseline (real implementation)
