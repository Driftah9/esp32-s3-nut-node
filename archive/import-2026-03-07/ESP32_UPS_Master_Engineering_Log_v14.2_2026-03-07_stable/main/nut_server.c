/*============================================================================
 ...
 R4  v14.12 v14.2 metadata export:
     - device.mfr
     - device.model
     - device.serial
     - driver.name
     - compatibility aliases ups.mfr / ups.model
...
static void nut_handle_line(app_cfg_t *cfg, int fd, nut_session_t *sess, char *line)
{
    ...
    if (strcasecmp(argv[0], "GET") == 0 && argc >= 4 && strcasecmp(argv[1], "VAR") == 0) {
        ...
        else if (strcmp(var, "battery.runtime") == 0)
